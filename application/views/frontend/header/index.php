...
<body>
     <div class="header-top">
	   <div class="wrap"> 
			 ...
			 <div class="cssmenu">
				<ul>
					<li class="active"><a href="<?php echo base_url();?>index.php/Form">Account</a></li> |
					...
					<div class="row">
						<div class="col1">
							<div class="h_nav">
								...
								<ul>
									<li><a href="womens.html">Larysa Blouse</a></li>
									<li><a href="womens.html">Minuman Hangat</a></li>
									<li><a href="womens.html">Kopi </a></li>
									<li><a href="womens.html">Aneka Jus</a></li>
								</ul>	
							</div>							
						</div>
						<div class="col1">
    ...
    <div id="fwslider">
        <div class="slider_container">
            <div class="slide"> 
                ...
                <div class="slide_content">
                    <div class="slide_content_wrap">
                        <!-- Text title -->
                        <h4 class="title">Kantin Asrama ITS</h4>
                        <!-- /Text title -->
                        
                        <!-- Text description -->
                        <p class="description">SEGER SUMYAH</p>
                        <!-- /Text description -->
                    </div>
                </div>
                 <!-- /Texts container -->
            ...
            <div class="slide">
                ...
                <div class="slide_content">
                    <div class="slide_content_wrap">
                        <h4 class="title">Berbagai Macam Menu Makanan </h4>
                        <p class="description">Berbagai Macam Menu Minuman dan Jus</p>
                    </div>
                </div>
            </div>
            <!--/slide -->
		  ...
		  <div class="cont span_2_of_3">
			...
			<div class="top-box">
			 <div class="col_1_of_3 span_1_of_3"> 
			   <a href="single.html">
				<div class="inner_content clearfix">
					<div class="product_image">
						<img src="<?php echo $assets_location;?>images/pic.jpg" alt=""/>
					</div>
			   ...
			   <div class="col_1_of_3 span_1_of_3">
					...
					<div class="inner_content clearfix">
					<div class="product_image">
						<img src="<?php echo $assets_location;?>images/pic1.jpg" alt=""/>
					</div>
                    <div class="price">
					   <div class="cart-left">
							<p class="title">Lorem Ipsum simply</p>
				...
				<div class="col_1_of_3 span_1_of_3">
				 <a href="single.html">
				  <div class="inner_content clearfix">
					<div class="product_image">
						<img src="<?php echo $assets_location;?>images/pic2.jpg" alt=""/>
					</div>
			...
			<div class="top-box">
			  <div class="col_1_of_3 span_1_of_3">
				 ...
				 <div class="inner_content clearfix">
					<div class="product_image">
						<img src="<?php echo $assets_location;?>images/pic3.jpg" alt=""/>
					</div>
                    <div class="price">
					   <div class="cart-left">
							<p class="title">Lorem Ipsum simply</p>
				...
				<div class="col_1_of_3 span_1_of_3">
					...
					<div class="inner_content clearfix">
					<div class="product_image">
						<img src="<?php echo $assets_location;?>images/pic4.jpg" alt=""/>
					</div>
				...
				<div class="col_1_of_3 span_1_of_3">
				 ...
				 <div class="inner_content clearfix">
					<div class="product_image">
						<img src="<?php echo $assets_location;?>images/pic5.jpg" alt=""/>
					</div>
                    <div class="price">
					   <div class="cart-left">
							<p class="title">Lorem Ipsum simply</p>
			...
			<div class="top-box1">
			  <div class="col_1_of_3 span_1_of_3">
				 ...
				 <div class="inner_content clearfix">
					<div class="product_image">
						<img src="<?php echo $assets_location;?>images/pic6.jpg" alt=""/>
					</div>
                     <div class="sale-box"><span class="on_sale title_shop">New</span></div>	
                    <div class="price">
					   <div class="cart-left">
				...
				<div class="col_1_of_3 span_1_of_3">
				 <a href="single.html">
					<div class="inner_content clearfix">
					<div class="product_image">
						<img src="<?php echo $assets_location;?>images/pic7.jpg" alt=""/>
					</div>
					 <div class="sale-box1"><span class="on_sale title_shop">Sale</span></div>	
                    <div class="price">
					   <div class="cart-left">
				...
				<div class="col_1_of_3 span_1_of_3">
				 ...
				 <div class="inner_content clearfix">
					<div class="product_image">
						<img src="<?php echo $assets_location;?>images/pic8.jpg" alt=""/>
					</div>
                   	 <div class="sale-box"><span class="on_sale title_shop">New</span></div>	
                    <div class="price">
					   <div class="cart-left">
		  ...
		  <div class="top-box1">
		    ...
		    <div class="slider-wrapper theme-default">
              <div id="slider" class="nivoSlider">
                <img src="<?php echo $assets_location;?>images/t-img1.jpg"  alt="" />
               	<img src="<?php echo $assets_location;?>images/t-img2.jpg"  alt="" />
                <img src="<?php echo $assets_location;?>images/t-img3.jpg"  alt="" />
              </div>
             </div>
			...
			<div class="wrap">
			  <div class="section group example">
				<div class="col_1_of_2 span_1_of_2">
					<ul class="f-list">
					  <li><img src="<?php echo $assets_location;?>images/2.png"><span class="f-text">Free Shipping on orders over $ 100</span><div class="clear"></div></li>
					</ul>
				</div>
				<div class="col_1_of_2 span_1_of_2">
					<ul class="f-list">
			 ...
			 <div class="col_1_of_f_1 span_1_of_f_1">
			   <div class="section group example">
				 <div class="col_1_of_f_2 span_1_of_f_2">
				    <h3>Information</h3>
						<ul class="f-list1">
						    <li><a href="#">Menu makanan lengkap </a></li>
				            <li><a href="#">Menu lengkap penyetan </a></li>
				            <li><a href="#">Aneka minuman dan Jus</a></li>
				             <li><a href="#">Menu lengkap sego njamoer </a></li>
				            <li><a href="#">Jajanan ringan</a></li>
				            <li><a href="#">Batagor dan bakso</a></li>
			         	</ul>
 				 </div>
				 <div class="col_1_of_f_2 span_1_of_f_2">
				   <h3>Contact us</h3>
